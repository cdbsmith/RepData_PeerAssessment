...
This document presents the results in a report using a R markdown document that can be processed by the knitr package and be transformed into an HTML file for detailed viewing. Please note, the report is designed so that viewers will be able to read the related code as well.  
